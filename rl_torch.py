...
MEMORY_CAPACITY = 30000  #30000
BATCH_SIZE = 32
NN_size = 300  #300  before
...
class Actor(nn.Module):
    def __init__(self, s_dim, a_dim, a_bound):
        ...
        self.fc1 = nn.Linear(s_dim, NN_size)
        self.fc2 = nn.Linear(NN_size, a_dim)
...
class Critic(nn.Module):
    def __init__(self, s_dim, a_dim):
        ...
        self.fc1 = nn.Linear(s_dim, NN_size)
        self.fc2 = nn.Linear(a_dim, NN_size)
        self.fc3 = nn.Linear(NN_size, 1)
